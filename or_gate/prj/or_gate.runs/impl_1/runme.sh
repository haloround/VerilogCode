...
HD_PWD='D:/VerilogCode/or_gate/prj/or_gate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log or_gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source or_gate.tcl -notrace
